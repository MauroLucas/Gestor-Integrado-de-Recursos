...
class Contacto(db.Model):
    ...
    #Foreign key
    id_contactos = db.relationship('DatosUsuario', backref='DatosUsuario.id_datosUsuario', primaryjoin='DatosUsuario.id_contacto==Contacto.id_contacto')
    #Atributtes
...
class DatosUsuario(db.Model):
    ...
    #Relationship
    id_datosUsuarios = db.relationship('Usuario', backref='Usuario.id_datosUsuario', primaryjoin='Usuario.id_datosUsuario==DatosUsuario.id_datosUsuario')
    #Atributtes
...
class Usuario(db.Model):
    ...
    #Relationship
    id_usuarios_ = db.relationship('UsuarioXGrupo', backref='UsuarioXGrupo.id_usuario', primaryjoin='Usuario.id_usuario==UsuarioXGrupo.id_usuario')
...
class Grupo(db.Model):
    ...
    id_grupos = db.relationship('Comentario', backref='Cometario.id_comentario', primaryjoin='Grupo.id_grupo==Comentario.id_grupo')
    #Atributtes
    nombre = db.Column(db.String(80), unique=False, nullable=False)
